    ...
    <div className='exp-container'>
      ...
      <section id="experience1">
        <div className="experience">
          <img src="src\assets\tam.jpeg" alt="TAM Club Logo" />
          <div className="experience-details">
          <h2 className="experience-title">Co-Secretary at TAM VIT</h2>
      ...
      <section id="experience2">
        <div className="experience">
          <img src="src\assets\genpact.jpeg" alt="Internship Logo" />
          <div className="experience-details">
          <h2 className="experience-title">Data Science Internship at Genpact Corporation</h2>
